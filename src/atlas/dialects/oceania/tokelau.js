export default {
  ...
  name: "Tokelau",
  dialects: [
    { id: "tk-tokelauan", name: "Tokelauan" },
    { id: "tk-english", name: "Tokelau English" }
  ],
  ...
  coachPrompts: {
    general:
      "We will practice Tokelauan with a warm, gentle tone. Keep it natural and expressive."
  },
  ...
  pronunciationNotes: [
    "Tokelauan has open vowels and rhythmic flow.",
