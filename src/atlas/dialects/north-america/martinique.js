export default {
  ...
  name: "Martinique",
  dialects: [
    { id: "mq-french", name: "Martinican French" },
    { id: "mq-creole", name: "Martinican Creole" }
  ],
  ...
  coachPrompts: {
    general:
      "We will practice Martinican French and Creole with a warm, melodic tone. Keep it expressive and natural."
  },
