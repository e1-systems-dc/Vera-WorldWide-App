export default {
  ...
  name: "Cayman Islands",
  dialects: [
    { id: "ky-english", name: "Caymanian English" },
    { id: "ky-creole", name: "Cayman Creole" }
  ],
  ...
  coachPrompts: {
    general:
      "We will practice Caymanian English and Creole with a warm, rhythmic tone. Keep it expressive and natural."
  },
