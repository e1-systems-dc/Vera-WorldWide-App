export default {
  ...
  name: "Anguilla",
  dialects: [
    { id: "ai-english", name: "Anguillan English" },
    { id: "ai-creole", name: "Anguillan Creole" }
  ],
  ...
  coachPrompts: {
    general:
      "We will practice Anguillan English and Creole with a warm, rhythmic tone. Keep it expressive and natural."
  },
  ...
  pronunciationNotes: [
    "Anguillan Creole has rhythmic intonation.",
