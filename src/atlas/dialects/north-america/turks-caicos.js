export default {
  ...
  name: "Turks & Caicos",
  dialects: [
    { id: "tc-english", name: "Turks & Caicos English" },
    { id: "tc-creole", name: "Turks & Caicos Creole" }
  ],
  ...
  coachPrompts: {
    general:
      "We will practice Turks & Caicos English and Creole with a warm, rhythmic tone. Keep it expressive and natural."
  },

  starterPhrases: [
    { answer: "Wha goin' on?", expand: "Add how you're feeling." },
