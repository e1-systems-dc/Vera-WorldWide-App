export default {
  ...
  dialects: [
    { id: "jf-spanish", name: "Juan Fernández Spanish" }
  ],
  ...
  coachPrompts: {
    general:
      "We will practice island Spanish with a warm, calm tone. Keep it natural and friendly."
  },
  ...
  pronunciationNotes: [
    "Island Spanish is soft and melodic.",
